...
## Updates all hand-type text labels.
...
func setup(head_type: Label, mid_type: Label, tail_type: Label, col0: Label, col1: Label, col2: Label, col_xi: Label, shadow_type: Label, flash_type: Label, destroy_type: Label, shadow_score: Label, flash_score: Label, destroy_score: Label, play: Button) -> void:
...
func _update_column_types(hand: Array[CardData.PlayingCard]) -> void:
	...
	for i: int in range(3):
		var col_cards: Array[CardData.PlayingCard] = [hand[i], hand[i + 3], hand[i + 6]]
