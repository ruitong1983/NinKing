...
| # | 任务 | 说明 | 优先级 | 状态 |
|---|------|------|--------|------|
| F1.0a | **铁索连环 (n_c02) 史诗→稀有** | rarity: "rare"→"uncommon", cost: 8→6, 效果不变 | **P0** | ⬜ |
| F1.0b | **王牌侍从 (n_f02) 史诗→稀有** | rarity: "rare"→"uncommon", cost: 8→5, 效果不变 | **P0** | ⬜ |
| F1.0c | **清一色 (n_x03) 史诗→稀有** | rarity: "rare"→"uncommon", cost: 7→5, 效果不变 | **P0** | ⬜ |
