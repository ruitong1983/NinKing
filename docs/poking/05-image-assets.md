...
|---|---|---|---|---|---|
| `launch_bg.png` | `assets/images/background/` | 1920×1080, PNG | 主菜单背景 | `poking_main.tscn` → MainMenu/MenuBg | ✅ 占位 (FanKing) |
| `table_bg.png` | `assets/images/background/` | 1920×1080, PNG | 牌桌背景 | `poking_main.tscn` → GameBg | ✅ 占位 (FanKing) |
...
| 素材 | 数量 | 规格 | 说明 |
|---|---|---|---|
| 游戏 Logo | 1 | 512×128, PNG | POKING 像素艺术字 |
